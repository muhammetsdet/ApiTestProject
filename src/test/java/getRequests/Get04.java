...
*/
    ...
    public void get04(){
        ...
        //SoftAssertion code exception verse bile devam eden kodları calıstırmaya devam eder. Softassertion icin softassert classtan bir object olusturmamız gereklidir.
        //SoftAssert softAssert= new SoftAssert();

        response.then().assertThat().statusCode(200).contentType(ContentType.JSON).body("id", Matchers.hasSize(10));
